...
cl = LINETCR.LINE()
cl.login(token="El6Pjjq28d7dHlNWRHq1.6uwqSCkPbhGBQK+3TBwlmq.XmwPvwalRyD8l4461fGMtxKqWySHJ9rg97eVlvMybNU=")
cl.loginResult()

ki = LINETCR.LINE()
ki.login(token="ElzPaPRbZ7WFOrYCtzp7.tH7ryq7TheOLHpku+I0HfW.9dRE1tR2Xd6hC/J1KYcIcwZGD1lasDSN5IIK4UBn1Ko=")
ki.loginResult()

kk = LINETCR.LINE()
kk.login(token="ElLv56bR5xUlaifmYiw1.DBkmwcU9UnIB4wR/qgRUaq.8MnPlW/2hXuhyLsm0KKLrx2euJD3sk2ylDwxUtlzNjY=")
kk.loginResult()

ks = LINETCR.LINE()
ks.login(token="ElcnjYtflC1TSttb3a50.z66VyYiRQVMMw2yyr5dSea.5dO8QthWmtjK1b3bSNNDc9Zu/vmQWAAq6xYmi9sDt1I=")
ks.loginResult()

print "login success"
reload(sys)
sys.setdefaultencoding('utf-8')
helpMessage ="""⚠List Comment 
...
admin = ["ub736c5b1794f5aa30026d162d07ce5e6","ue7840bf42815883ff057f579eb204c32","udc95fd1f4319165c3f41520a38571eba","u3eaead8df754cf0c57fabea5a539aa42"]
...
Rx3 = ["ue7840bf42815883ff057f579eb204c32"]
Rx2 = ["udc95fd1f4319165c3f41520a38571eba"]
Rx1 = ["u3eaead8df754cf0c57fabea5a539aa42"]
...
wait = {
    ...
    "lang":"JP",
    "comment":"Auto like by 🍒🍁Queen🍁🍒\n\nOPEN ORDER\n🍒SELFBOT\n🍒ORDER&SEWA BOT PROTECT\n🍒TICKET SIRI\n🍒GIFT TIKEL&THEMA LINE\n🍒VIP SMULE 25/SETAHUN\n\nThanks Before😘😘😘",
    "likeOn":True,
    "commentOn":True,
    "commentBlack":{},
    "wblack":False,
            ...
            if msg.contentType == 13:
                ...
                if msg.toType == 2:
                    ...
                    if group.invitee is not None:
                        ...
                        if wait["lang"] == "JP":
                            ks.sendText(msg.to,"There isn't an invited person。")
                        else:
                            ks.sendText(msg.to,"you Sato face-like person absence。")
                else:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"It can't be used besides the group。")
                    else:
...
#--------------------------------------------------------
                ...
                if wait["autoAdd"] == True: md+="Auto_add → on\n"
...
#-----------------------------------------------------------
                ...
                OWN = "u7c6053763344625bb1159355020c5c27","ue7840bf42815883ff057f579eb204c32","udc95fd1f4319165c3f41520a38571eba","u3eaead8df754cf0c57fabea5a539aa42"
                if msg.from_ in OWN:
                    pass
                else:
